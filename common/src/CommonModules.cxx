...
void CommonModules::init(Context & ctx, const std::string & SysType_PU){
  ...
  if(is_mc){
    ...
    if(jec){
      ...
      jec_switcher_2017UL.reset(new RunSwitcher(ctx, "2017"));
      for (const auto & runItr : runPeriods2017) {
        jec_switcher_2017UL->setupRun(runItr, std::make_shared<JetCorrector>(ctx, JERFiles::JECFilesDATA(jec_tag_2017UL, jec_ver_2017UL, jec_jet_coll, runItr)));
      }

      jec_switcher_UL18.reset(new RunSwitcher(ctx, "2018"));
      for (const auto & runItr : runPeriods2018) {
        jec_switcher_UL18->setupRun(runItr, std::make_shared<JetCorrector>(ctx, JERFiles::JECFilesDATA(jec_tag_UL18, jec_ver_UL18, jec_jet_coll, runItr)));
      }
      ...
      jet_corrector_data->setup2017UL(jec_switcher_2017UL);
  ...
  if(jetlepcleaner) {
    if(is_mc) {
      ...
      JLC_MC->setup2017UL(std::make_shared<JetLeptonCleaner_by_KEYmatching>(ctx, JERFiles::JECFilesMC(jec_tag_2017UL, jec_ver_2017UL, jec_jet_coll)));
      ...
      JLC_switcher_2017UL.reset(new RunSwitcher(ctx, "2017"));
      for (const auto & runItr : runPeriods2017) {
        JLC_switcher_2017UL->setupRun(runItr, std::make_shared<JetCorrector>(ctx, JERFiles::JECFilesDATA(jec_tag_2017UL, jec_ver_2017UL, jec_jet_coll, runItr)));
      }
      ...
      JLC_data->setup2017UL(JLC_switcher_2017UL);
