...
def plot_reso(reso_hists, folder, reso_mean_rms, name, ymin=0.1, ymax=0.4,blogy = False):
    ...
    colors = [kRed,(kAzure-4),kBlack, kOrange-3,kAzure,kSpring,kGreen, kBlue,kBlue,kBlue,kBlue,kBlue] 
...
TH1.AddDirectory(0)
infile_dict_CHSVersion["PUPPI v13 no eta cut"]=infile_puppi_inc_2017_v13ultimative
...
TH1.AddDirectory(0)
infile_dict_CHSVersion["PUPPI v13 with eta cut"]=infile_puppi_inc_2017_v13_newPR
...
infile_QCD_CHS = TFile("/nfs/dust/cms/user/deleokse/analysis/PUPPI_tuning/rootfiles/uhh2.AnalysisModuleRunner.MC.QCD_2017v2_chs.root")
TH1.AddDirectory(0)
