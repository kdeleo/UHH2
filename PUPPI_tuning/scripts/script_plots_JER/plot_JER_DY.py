...
def plot_control(hists,folder):
    ...
    markers = [21,20,24,34,22,20,24,20,22,21,34,24,20,20,20,20,20,20]
    colors = [kAzure-4,kBlack,kViolet,kOrange-3,kRed,kViolet,kViolet-6,kBlack,kRed,kAzure-4,kOrange-3,kViolet-6,kBlack,kOrange-3,kRed,kBlack,kAzure-4, kBlack, kOrange-3,kAzure,kSpring,kGreen, kBlue,kBlue,kBlue,kBlue,kBlue]
    print "plot control"
...
#                if bin%100 != 0: continue
                ...
                #projection.GetXaxis().SetRangeUser(1.5,5.0)
    ...
    for key in hist_dict:
        ...
        for key2 in sorted(hist_dict,reverse=True):
            ...
            #projection2.GetXaxis().SetRangeUser(1.5,5.0)
            #projection2.GetXaxis().SetRangeUser(0.5,3.0)
...
def plot_reso(reso_hists, folder, reso_mean_rms, name, ymin=0.1, ymax=0.4,blogy = False):
    ...
    colors = [kRed,kOrange-3,kBlack,kAzure-4,kViolet,kOrange-3,kViolet-6,kSpring,kGreen, kBlue,kBlue,kBlue,kBlue,kBlue] 
...
infile_puppi_inc_2017UL_v14_Laurent = TFile("/nfs/dust/cms/user/deleokse/analysis/PUPPI_tuning/rootfilesDY_UL_JECorder/uhh2.AnalysisModuleRunner.MC.MC_DY_2017UL_v14_Laurent.root")
TH1.AddDirectory(0)
infile_dict_CHSVersion["PUPPI Laurent tune"]=infile_puppi_inc_2017UL_v14_Laurent 

### PUPPI v14 - Laurent tune NPVcut 
infile_puppi_inc_2017UL_v14_Laurent_NPVcut = TFile("/nfs/dust/cms/user/deleokse/analysis/PUPPI_tuning/rootfilesDY_UL_JECorder/uhh2.AnalysisModuleRunner.MC.MC_DY_2017UL_v14_Laurent_NPVcut.root")
TH1.AddDirectory(0)
infile_dict_CHSVersion["PUPPI Laurent tune NPVcut"]=infile_puppi_inc_2017UL_v14_Laurent_NPVcut 

### Original QCD file from 2017 in CMSSW106
infile_QCD_orig_2017_106 = TFile("/nfs/dust/cms/user/deleokse/analysis/PUPPI_tuning/rootfilesDY_UL_JECorder/uhh2.AnalysisModuleRunner.MC.MC_DY_2017UL_default.root")
TH1.AddDirectory(0)
