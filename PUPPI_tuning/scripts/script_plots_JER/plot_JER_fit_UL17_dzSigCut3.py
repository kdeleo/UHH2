...
def plot_control(hists,folder):
    markers = [20,21,34,24,22,20,24,20,22,21,34,24,20,20,20,20,20,20]
    colors = [kBlack,kAzure-4,kOrange-3,kViolet-6,kRed,kViolet-6,kBlack,kRed,kAzure-4,kOrange-3,kViolet-6,kBlack,kOrange-3,kRed,kBlack,kAzure-4, kBlack, kOrange-3,kAzure,kSpring,kGreen, kBlue,kBlue,kBlue,kBlue,kBlue]
    print "plot control"
...
def plot_reso(reso_hists, folder, reso_mean_rms, name, ymin=0.1, ymax=0.4,blogy = False):
    ...
    markers = [22,24,34,21,20,24,34,24,20,20,20,20,20,20]
    colors = [kRed,kViolet-6,kOrange-3,kAzure-4,kBlack,kOrange-3,kViolet-6,kSpring,kGreen, kBlue,kBlue,kBlue,kBlue,kBlue] 
...
folder_CHS = "dzSigCut3_JER_UL17/"



### PUPPI dzSigCut3 
infile_puppi_inc_2017UL_dzSigCut3 = TFile("/nfs/dust/cms/user/deleokse/analysis/PUPPI_tuning/rootfilesUL_dzSigCut3/uhh2.AnalysisModuleRunner.MC.QCD_2017UL_dzSigCut3.root")
TH1.AddDirectory(0)
infile_dict_CHSVersion["PUPPI dzSig fromPV12"]=infile_puppi_inc_2017UL_dzSigCut3 

### PUPPI dzSigCut3 allfromPV 
infile_puppi_inc_2017UL_dzSigCut3_allfromPV = TFile("/nfs/dust/cms/user/deleokse/analysis/PUPPI_tuning/rootfilesUL_dzSigCut3/uhh2.AnalysisModuleRunner.MC.QCD_2017UL_dzSigCut3_allfromPV.root")
TH1.AddDirectory(0)
infile_dict_CHSVersion["PUPPI dzSig allfromPV"]=infile_puppi_inc_2017UL_dzSigCut3_allfromPV
