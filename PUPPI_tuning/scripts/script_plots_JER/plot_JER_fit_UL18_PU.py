...
def plot_control(hists, folder):
    ...
    markers = [20,21,22,34,28,20,20,20,20,20,20]
    #colors = [(kAzure-4), kRed, kBlack, kOrange-3,kAzure,kSpring,kGreen, kBlue,kBlue,kBlue,kBlue,kBlue]
    colors = [kBlack,(kAzure-4), kRed, kOrange-3,kAzure,kSpring,kGreen, kBlue,kBlue,kBlue,kBlue,kBlue]
    print "plot control"
...
folder_CP = "JER_fit_UL18_PU40/ChargedPRotection/"
...
###
infile_dict_dzcut={}
folder_dzcut = "JER_fit_UL18_PU40/PUPPI_dzcut/"
