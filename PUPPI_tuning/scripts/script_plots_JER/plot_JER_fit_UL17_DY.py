...
import time
import datetime
from ROOT import TFile,TCanvas,gROOT,gStyle,TLegend,TGraphAsymmErrors,kGreen,kOrange,kSpring,TF1,kAzure, TH2F,TH1F,gPad, TPaveText, TH1,kRed,SetOwnership, TMath, kBlue, kBlack, kFALSE, kTRUE,kSienna,TLatex, Double, TMultiGraph, TString, TF1, kMagenta, kViolet
...
def plot_control(hists,folder):
    ...
    markers = [24,20,21,22,34,25,20,22,21,34,24,20,20,20,20,20,20]
    colors = [kViolet-6,kBlack,kAzure-4,kRed,kOrange,kBlue,kRed,kAzure-4,kOrange-3,kViolet-6,kBlack,kOrange-3,kRed,kBlack,kAzure-4, kBlack, kOrange-3,kAzure,kSpring,kGreen, kBlue,kBlue,kBlue,kBlue,kBlue]
    print "plot control"
...
#                if bin%100 != 0: continue
    ...
    for key in hist_dict:
        ...
        i=0
        for key2 in sorted(hist_dict,reverse=True):
            ...
            legname.ReplaceAll("PU0to10_","")
            legname.ReplaceAll("PU10to20_","")
            legname.ReplaceAll("PU30to40_","")
            legname.ReplaceAll("PU40to50_","")
            legname.ReplaceAll("PU50to70_","")
...
def plot_reso(reso_hists, folder, reso_mean_rms, name, ymin=0.1, ymax=0.4,blogy = False):
    ...
    markers = [22,21,20,24,34,24,20,20,20,20,20,20]
    colors = [kRed,kAzure-4,kBlack,kViolet-6,kOrange-3,kViolet-6,kSpring,kGreen, kBlue,kBlue,kBlue,kBlue,kBlue] 
...
folder_CHS = "JER_UL17_DY/"



#### PUPPI v13   
#infile_puppi_inc_2017UL_v13 = TFile("/nfs/dust/cms/user/deleokse/analysis/PUPPI_tuning/rootfilesDY_UL_JECorder/uhh2.AnalysisModuleRunner.MC.MC_DY_2017UL_v13.root")
#TH1.AddDirectory(0)
#infile_dict_CHSVersion["PUPPI v13"]=infile_puppi_inc_2017UL_v13

### PUPPI v14 - V4   
infile_puppi_inc_2017UL_v14 = TFile("/nfs/dust/cms/user/deleokse/analysis/PUPPI_tuning/rootfilesDY_UL_JECorder/uhh2.AnalysisModuleRunner.MC.MC_DY_2017UL_v14.root")
TH1.AddDirectory(0)
infile_dict_CHSVersion["PUPPI v14"]=infile_puppi_inc_2017UL_v14

### PUPPI v14 - V5
infile_puppi_inc_2017UL_v14_V5 = TFile("/nfs/dust/cms/user/deleokse/analysis/PUPPI_tuning/rootfilesDY_UL_V5/uhh2.AnalysisModuleRunner.MC.MC_DY_2017UL_v14.root")
TH1.AddDirectory(0)
infile_dict_CHSVersion["PUPPI v14 V5"]=infile_puppi_inc_2017UL_v14_V5

### PUPPI v14 - V5 ptclip8
#infile_puppi_inc_2017UL_v14_V5_ptclip = TFile("/nfs/dust/cms/user/deleokse/analysis/PUPPI_tuning/rootfilesDY_UL_ptclip8/uhh2.AnalysisModuleRunner.MC.MC_DY_2017UL_v14.root")
infile_puppi_inc_2017UL_v14_V5_ptclip = TFile("/nfs/dust/cms/user/deleokse/analysis/PUPPI_tuning/rootfilesDY_UL_ptclip8Check/uhh2.AnalysisModuleRunner.MC.MC_DY_2017UL_v14.root")
TH1.AddDirectory(0)
infile_dict_CHSVersion["PUPPI v14 V5 ptclip"]=infile_puppi_inc_2017UL_v14_V5_ptclip

### DY PUPPI file from 2017 in CMSSW106
infile_QCD_orig_2017_106 = TFile("/nfs/dust/cms/user/deleokse/analysis/PUPPI_tuning/rootfilesDY_UL_JECorder/uhh2.AnalysisModuleRunner.MC.MC_DY_2017UL.root")
TH1.AddDirectory(0)
infile_dict["PUPPI default"]=infile_QCD_orig_2017_106
infile_dict_CHSVersion["PUPPI default"]=infile_QCD_orig_2017_106

#### DY CHS file from 2017 in CMSSW106 
#infile_QCD_CHS = TFile("/nfs/dust/cms/user/deleokse/analysis/PUPPI_tuning/rootfilesDY_UL_JECorder/uhh2.AnalysisModuleRunner.MC.MC_DY_2017UL_chs.root")
#TH1.AddDirectory(0)
...
hists_CHS = get_hists(infile_dict_CHSVersion,"jet_output")
