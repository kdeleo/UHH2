...
def plot(eff_list,leg_list,folder,filenamebase,nameX,nameY, miny=0, legxmin = 0.5,legymin=0.3,legxmax=0.8,legymax=0.5, maxy = 1.05, setmarker=False,markers=marker_sel, textalign =31, all_pre = False):
    ...
    if "Pt" in filenamebase:     hr = c.DrawFrame(25,0.8,85,maxy);  #zoom in 
...
################################################################
    ############ CHS in UL 2017 
    #infile_chs_UL_17 = TFile("/nfs/dust/cms/user/deleokse/analysis/PUPPI_tuning/rootfilesDY_UL_newJECs/uhh2.AnalysisModuleRunner.MC.MC_DY_2017UL_chs.root")
    infile_chs_UL_17 = TFile("/nfs/dust/cms/user/deleokse/analysis/PUPPI_tuning/rootfilesDY_UL_JECorder/uhh2.AnalysisModuleRunner.MC.MC_DY_2017UL_chs.root")
    TH1.AddDirectory(0)

    ############ Puppi default in UL 2017 
    #infile_puppi_UL_17 = TFile("/nfs/dust/cms/user/deleokse/analysis/PUPPI_tuning/rootfilesDY_UL_newJECs/uhh2.AnalysisModuleRunner.MC.MC_DY_2017UL_default.root")
    infile_puppi_UL_17 = TFile("/nfs/dust/cms/user/deleokse/analysis/PUPPI_tuning/rootfilesDY_UL_JECorder/uhh2.AnalysisModuleRunner.MC.MC_DY_2017UL.root")
    TH1.AddDirectory(0)

    ############ Puppi v13 in UL 2017 
    #infile_puppi_v13_UL_17 = TFile("/nfs/dust/cms/user/deleokse/analysis/PUPPI_tuning/rootfilesDY_UL_newJECs/uhh2.AnalysisModuleRunner.MC.MC_DY_2017UL_v13.root")
    infile_puppi_v13_UL_17 = TFile("/nfs/dust/cms/user/deleokse/analysis/PUPPI_tuning/rootfilesDY_UL_JECorder/uhh2.AnalysisModuleRunner.MC.MC_DY_2017UL_v13.root")
    TH1.AddDirectory(0)

    ############ Puppi v14 in UL 2017 - V4 JECs 
    #infile_puppi_v14_UL_17 = TFile("/nfs/dust/cms/user/deleokse/analysis/PUPPI_tuning/rootfilesDY_UL_noJECs/uhh2.AnalysisModuleRunner.MC.MC_DY_2017UL_v14.root")
    #infile_puppi_v14_UL_17 = TFile("/nfs/dust/cms/user/deleokse/analysis/PUPPI_tuning/rootfilesDY_UL_newJECs/uhh2.AnalysisModuleRunner.MC.MC_DY_2017UL_v14.root")
    ...
    infile_puppi_v14_UL_17_noptclip = TFile("/nfs/dust/cms/user/deleokse/analysis/PUPPI_tuning/rootfilesDY_UL_noptclip/uhh2.AnalysisModuleRunner.MC.MC_DY_2017UL_v14.root")
    TH1.AddDirectory(0)

    ############ Puppi v14 in UL 2017 - V5 ptclip8 
    #infile_puppi_v14_UL_17_ptclip = TFile("/nfs/dust/cms/user/deleokse/analysis/PUPPI_tuning/rootfilesDY_UL_ptclip8/uhh2.AnalysisModuleRunner.MC.MC_DY_2017UL_v14.root")
    infile_puppi_v14_UL_17_ptclip = TFile("/nfs/dust/cms/user/deleokse/analysis/PUPPI_tuning/rootfilesDY_UL_ptclip8Check/uhh2.AnalysisModuleRunner.MC.MC_DY_2017UL_v14.root")
    TH1.AddDirectory(0)

    ############ Puppi v14 in UL 2017 - V5 
    infile_puppi_v14_UL_17_V5 = TFile("/nfs/dust/cms/user/deleokse/analysis/PUPPI_tuning/rootfilesDY_UL_V5/uhh2.AnalysisModuleRunner.MC.MC_DY_2017UL_v14.root")
    TH1.AddDirectory(0)
...
################################################################
    ...
    lista = infile_puppi_UL_17.Get(hist_folder).GetListOfKeys()
    nameX="NaN"
...
#            eff_CHS_PUIDTight_pt20_gluon =calculate_eff(infile_CHS_PUIDTight_pt20,"gluon_EffPurity_output",el.GetName(),el.GetName()+postfix)
            ...
            ##### chs UL 2017
            eff_chs_UL_17 =calculate_eff(infile_chs_UL_17,hist_folder,el.GetName(),el.GetName()+postfix)

            ##### puppi default UL 2017
            eff_puppi_default_UL_17 =calculate_eff(infile_puppi_UL_17,hist_folder,el.GetName(),el.GetName()+postfix)

            ##### puppi v13 UL 2017
            eff_v13_UL_17 =calculate_eff(infile_puppi_v13_UL_17,hist_folder,el.GetName(),el.GetName()+postfix)
            ...
            ##### puppi v14 UL 2017 - V5 ptclip8
            eff_v14_UL_17_ptclip =calculate_eff(infile_puppi_v14_UL_17_ptclip,hist_folder,el.GetName(),el.GetName()+postfix)

            ##### puppi v14 UL 2017 - V5 
            eff_v14_UL_17_V5 =calculate_eff(infile_puppi_v14_UL_17_V5,hist_folder,el.GetName(),el.GetName()+postfix)
...
#                plot(hists,legnames,folder+"/chargProtection_ptcut8GeV/","eff_alljets_"+el.GetName(),nameX,"Efficiency",0.6, 0.15,0.15,0.45,0.45,1.1,True)
            ...
            if b_2016_vs_2017_vs_2018:
                ...
                hists =[eff_puppi_default_UL_17,eff_chs_UL_17,eff_v14_UL_17_noptclip] 
                legnames = ["PUPPI default UL17","CHS UL17","PUPPI v14 no ptclip"]
...
#            purity_puppi_2016_chprot_fromPV = calculate_eff(infile_puppi_2016_chprot_fromPV,"jet_pt_8/",el.GetName(),el.GetName()+postfix)
            ...
            ##### puppi default UL 2017
            purity_puppi_default_UL_17 =calculate_eff(infile_puppi_UL_17,hist_folder,el.GetName(),el.GetName()+postfix)

            ##### chs UL 2017
            purity_chs_UL_17 =calculate_eff(infile_chs_UL_17,hist_folder,el.GetName(),el.GetName()+postfix)

            ##### puppi v13 UL 2017
            purity_v13_UL_17 =calculate_eff(infile_puppi_v13_UL_17,hist_folder,el.GetName(),el.GetName()+postfix)
            ...
            ##### puppi v14 UL 2017 - V5 ptclip
            purity_v14_UL_17_ptclip =calculate_eff(infile_puppi_v14_UL_17_ptclip,hist_folder,el.GetName(),el.GetName()+postfix)

            ##### puppi v14 UL 2017 - V5 
            purity_v14_UL_17_V5 =calculate_eff(infile_puppi_v14_UL_17_V5,hist_folder,el.GetName(),el.GetName()+postfix)
...
#                plot(hists,legnames,folder+"/chargProtection_ptcut8GeV/","purity_alljets_"+el.GetName(),nameX,"Purity",0, 0.15,0.15,0.45,0.45,1.1,True)
            ...
            if b_2016_vs_2017_vs_2018:
                ...
                #legnames = ["PUPPI default","CHS","PUPPI v13 beagle"]
                hists =[purity_puppi_default_UL_17,purity_chs_UL_17,purity_v14_UL_17_noptclip] 
                legnames = ["PUPPI default UL17","CHS UL17","PUPPI v14 noptclip"]
