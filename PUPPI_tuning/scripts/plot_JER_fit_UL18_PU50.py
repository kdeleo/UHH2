...
folder_CP = "JER_fit_UL18_PU50/ChargedPRotection/"

###
# all variante of PUPPI CHS versions included
###
infile_dict_CHSVersion={}
folder_CHS = "JER_fit_UL18_PU50/PUPPI_CHSVersions/"

###
# all variants of the dzcut true/false included
###
infile_dict_dzcut={}
folder_dzcut = "JER_fit_UL18_PU50/PUPPI_dzcut/"




### PUPPI v13 - new PR  
infile_puppi_inc_2018UL_v13 = TFile("/nfs/dust/cms/user/deleokse/analysis/PUPPI_tuning/rootfilesUL/uhh2.AnalysisModuleRunner.MC.QCD_2018UL_v13.root")
TH1.AddDirectory(0)
...
infile_QCD_CHS = TFile("/nfs/dust/cms/user/deleokse/analysis/PUPPI_tuning/rootfilesUL/uhh2.AnalysisModuleRunner.MC.QCD_2018UL_chs.root")
TH1.AddDirectory(0)
