...
def plot_control(hists,folder):
    ...
    markers = [24,20,21,22,20,24,20,22,21,34,24,20,20,20,20,20,20]
    colors = [kViolet-6,kBlack,kAzure-4,kRed,kBlack,kViolet-6,kBlack,kRed,kAzure-4,kOrange-3,kViolet-6,kBlack,kOrange-3,kRed,kBlack,kAzure-4, kBlack, kOrange-3,kAzure,kSpring,kGreen, kBlue,kBlue,kBlue,kBlue,kBlue]
    print "plot control"
...
### PUPPI v14 tune - dzcut for eta > 2.4  
