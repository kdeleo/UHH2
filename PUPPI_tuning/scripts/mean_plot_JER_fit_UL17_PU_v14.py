...
def get_hists(infile_dict,hist_folder):
    ...
    #if infile_dict.has_key("PUPPI v13"):
    #    lista = infile_dict["PUPPI v13"].Get(hist_folder).GetListOfKeys()
    if infile_dict.has_key("PUPPI v14 new"):
        lista = infile_dict["PUPPI v14 new"].Get(hist_folder).GetListOfKeys()
    else:
...
folder_CHS = "mean_UL17_v14_slope/"
