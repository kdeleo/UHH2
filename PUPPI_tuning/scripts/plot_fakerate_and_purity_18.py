...
def calculate_eff(infile,folder,name_all,name_trig,name='orig'):
    ...
    if "NPV" in el.GetName():
        ...
        hist_all = hist_all.Rebin(7,hist_all.GetTitle(),bins)
        print hist_all.Integral()
        hist_trig = hist_trig.Rebin(7,hist_trig.GetTitle(),bins)
...
#    infile_CHS_PUIDMedium_pt20 = TFile("/nfs/dust/cms/user/abenecke/ZPrimeTotTPrime/CMSSW_8X/rootfiles/puppi_DY/uhh2.AnalysisModuleRunner.MC.MC_DY_inc_CHS_effpurity_medium_ptcut20GeV.root")
    ...
    infile_puppi_2017_CMSSW102 = TFile("/nfs/dust/cms/user/deleokse/analysis/PUPPI_tuning/rootfiles2/uhh2.AnalysisModuleRunner.MC.MC_DY_2017v2.root")
    TH1.AddDirectory(0)
    ...
    infile_puppi_2018_CMSSW102 = TFile("/nfs/dust/cms/user/deleokse/analysis/PUPPI_tuning/rootfiles2/uhh2.AnalysisModuleRunner.MC.MC_DY_2018_puppi.root")
    TH1.AddDirectory(0)
    ...
    infile_chs_2017_CMSSW102 = TFile("/nfs/dust/cms/user/deleokse/analysis/PUPPI_tuning/rootfiles2/uhh2.AnalysisModuleRunner.MC.MC_DY_2017v2_chs.root")
    TH1.AddDirectory(0)
    ...
    infile_chs_2018_CMSSW102 = TFile("/nfs/dust/cms/user/deleokse/analysis/PUPPI_tuning/rootfiles2/uhh2.AnalysisModuleRunner.MC.MC_DY_2018_chs.root")
    TH1.AddDirectory(0)
    ...
    infile_puppi_v13_newPR_17 = TFile("/nfs/dust/cms/user/deleokse/analysis/PUPPI_tuning/rootfiles2/uhh2.AnalysisModuleRunner.MC.MC_DY_2017v2_v13_PR.root")
    TH1.AddDirectory(0)

    ############ puppi v13 newPR 2018
    infile_puppi_v13_newPR_18 = TFile("/nfs/dust/cms/user/deleokse/analysis/PUPPI_tuning/rootfiles2/uhh2.AnalysisModuleRunner.MC.MC_DY_2018_v13_PR.root")
    TH1.AddDirectory(0)
