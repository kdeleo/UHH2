...
folder_CP = "JER_fit_16_ak8_PU50/ChargedPRotection/"

###
# all variante of PUPPI CHS versions included
###
infile_dict_CHSVersion={}
folder_CHS = "JER_fit_16_ak8_PU50/PUPPI_CHSVersions/"

###
# all variants of the dzcut true/false included
###
infile_dict_dzcut={}
folder_dzcut = "JER_fit_16_ak8_PU50/PUPPI_dzcut/"
...
### PUPPI v13 new PR
infile_puppi_inc_2016_v13_newPR = TFile("/nfs/dust/cms/user/deleokse/analysis/PUPPI_tuning/rootfiles2/uhh2.AnalysisModuleRunner.MC.QCD_2016v2_v13_newPR_ak8_PU50.root")
TH1.AddDirectory(0)
infile_dict_CHSVersion["PUPPI v13 beagle"]=infile_puppi_inc_2016_v13_newPR

### Original QCD file from 2016v2 in CMSSW102
infile_QCD_orig_2016_102 = TFile("/nfs/dust/cms/user/deleokse/analysis/PUPPI_tuning/rootfiles2/uhh2.AnalysisModuleRunner.MC.QCD_2016v2_ak8_PU50.root")
TH1.AddDirectory(0)
...
infile_QCD_CHS = TFile("/nfs/dust/cms/user/deleokse/analysis/PUPPI_tuning/rootfiles2/uhh2.AnalysisModuleRunner.MC.QCD_2016v2_ak8_chs_PU50.root")
TH1.AddDirectory(0)
