...
class QCDEffPurityModule: public AnalysisModule {
public:
    
    explicit QCDEffPurityModule(Context & ctx);
...
private:
  ...
  std::unique_ptr<PuppiJetHists> h_puppi_jet_pt_8_wJEC;
...
QCDEffPurityModule::QCDEffPurityModule(Context & ctx){
    ...
    h_puppi_jet_pt_8_wJEC.reset(new PuppiJetHists(ctx, "puppi_jet_pt_8_wJEC"));
...
bool QCDEffPurityModule::process(Event & event) {
...
UHH2_REGISTER_ANALYSIS_MODULE(QCDEffPurityModule)
