...
class PuppiJetHists_ak8: public uhh2::Hists {
public:
    // use the same constructor arguments as Hists for forwarding:
    PuppiJetHists_ak8(uhh2::Context & ctx, const std::string & dirname, const std::string & collection="");

    virtual void fill(const uhh2::Event & ev) override;
    virtual ~PuppiJetHists_ak8();
  protected:
    bool berror;
    double pTcut;
    const std::string collection;
    Event::Handle<vector<TopJet>> h_myjets;
